...
namespace pdb_utils{
    ...
    static constexpr double hbond_cutoff=3.2; // hydrogen bond cutoff
...
//  ==============================================
    ...
    inline bool is_rna_polar_atom(const std::string& atype){
        bool flag = false;
    ...
    inline std::string format_rna(const std::string oldstr){
    ...
    inline std::string protein_tri2sin(const std::string &str_tri){
